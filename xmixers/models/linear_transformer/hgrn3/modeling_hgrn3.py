...
class Hgrn3PreTrainedModel(PreTrainedModel):
    config_class = Hgrn3Config
    supports_gradient_checkpointing = True
    _no_split_modules = ["Hgrn3Layer"]
...
class Hgrn3Model(Hgrn3PreTrainedModel):
    def __init__(self, config: Hgrn3Config):
...
class Hgrn3ForCausalLM(Hgrn3PreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from transformers import AutoTokenizer, Hgrn3ForCausalLM

        >>> model = Hgrn3ForCausalLM.from_pretrained(PATH_TO_CONVERTED_WEIGHTS)
